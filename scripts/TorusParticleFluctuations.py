...
from src.utilities import ExtractFluctuationsFromFile
import numpy as np
import argparse
...
parser.add_argument("--nbr-iter", action="store", default=-1,
                    help="number of Monte Carlo iterations")
parser.add_argument("--nbr-nonthermal", action="store", default=-1,
                    help="number of non-thermal iterations")
parser.add_argument("--step", action="store", default=-1,
                    help="step size value at square aspect ratio")
parser.add_argument("--A-start", action="store", default=-1,
...
parser.add_argument("--extract", action="store_true",
                    help="extract the fluctuations from the existing data without running MC again")
